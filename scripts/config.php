...
$mmfpm_db['addr']     = $sqlhost;         // SQL server IP:port this DB located on
$mmfpm_db['user']     = $sqluser;                   // SQL server login this DB located on
$mmfpm_db['pass']     = $sqlpass;                      // SQL server pass this DB located on
$mmfpm_db['name']     = $mmdb;                  // MiniManager DB name
$mmfpm_db['encoding'] = 'utf8';                   // SQL connection encoding
$realm_db['addr']     = $sqlhost;          // SQL server IP:port this realmd located on
$realm_db['user']     = $sqluser;                    // SQL server login this realmd located on
$realm_db['pass']     = $sqlpass;                      // SQL server pass this realmd located on
$realm_db['name']     = $realmdb;                 // realmd DB name
$realm_db['encoding'] = 'utf8';                   // SQL connection encoding

          // position in array must represent realmd ID
$world_db[1]['addr']          = $sqlhost; // SQL server IP:port this DB located on
$world_db[1]['user']          = $sqluser;            // SQL server login this DB located on
$world_db[1]['pass']          = $sqlpass;              // SQL server pass this DB located on
$world_db[1]['name']          = $worlddb;         // World Database name
$world_db[1]['encoding']      = 'utf8';           // SQL connection encoding

               // position in array must represent realmd ID
$characters_db[1]['addr']     = $sqlhost; // SQL server IP:port this DB located on
$characters_db[1]['user']     = $sqluser;            // SQL server login this DB located on
$characters_db[1]['pass']     = $sqlpass;              // SQL server pass this DB located on
$characters_db[1]['name']     = $chardb;     // Character Database name
...
$server[1]['addr_wan']      = '76.119.235.255'; // Game Server IP, as seen by clients - Must be external address
...
$irc_cfg['server']  = $ircserver; // irc server
$irc_cfg['port']    =  $ircport;            // port
$irc_cfg['channel'] = $ircchan;    // channel
...
$enable_captcha         = false;     // false = no security image check (enable for protection against 'bot' registrations) captcha needs php GD & FreeType Library support
...
$theme               = 'Universe';    // file/folder name of theme to use from themes directory by default
...
(
  ...
  (              'index.php',        'main', array
    (
      ...
      array(     'forum/index.php',      'forums', 0,5,5,5), // has own level security, but has yet to honor the new security system.
