		...
		<table class=\"hidden\">
			...
			<tr>
				...
				<tr>
					...
					<td>
						<input type=\"text\" size=\"10\" maxlength=\"10\" name=\"lootid\" />
					</td>
				</tr>
				<tr>
					...
					<td>
						<input type=\"text\" size=\"25\" maxlength=\"50\" name=\"ScriptName\" />
					</td>
				</tr>
				<tr>
...
if ($loc_language)
	$db_query = "SELECT ct.entry, ct.name, ct.maxlevel, ct.maxhealth, ct.rank, ct.npcflag, lc.name_loc{$loc_language} FROM creature_template ct LEFT OUTER JOIN locales_creature lc on lc.entry = ct.entry WHERE {$where} ORDER BY ct.entry LIMIT 100";
else
...
if (!$do_insert)
{
	...
	$result = $sql->query("SELECT `entry`, `difficulty_entry_1`, `KillCredit1`, `KillCredit2`, `modelid_A`, `modelid_A2`, `modelid_H`, `modelid_H2`, `name`,`subname`, `IconName`, `minlevel`, `maxlevel`, `minhealth`, `maxhealth`, `minmana`, `maxmana`, `armor`,`faction_A`, `faction_H`, `npcflag`, `speed`,`scale`,`rank`,`mindmg`, `maxdmg`, `dmgschool`, `attackpower`, `baseattacktime`, `rangeattacktime`, `unit_flags`,`dynamicflags`, `family`, `trainer_type`, `trainer_spell`, `trainer_class`,`trainer_race`,`minrangedmg`, `maxrangedmg`, `rangedattackpower`, `type`,`type_flags`,`lootid`, `pickpocketloot`, `skinloot`, `resistance1`, `resistance2`, `resistance3`, `resistance4`, `resistance5`, `resistance6`, `spell1`, `spell2`, `spell3`, `spell4`, `PetSpellDataId`, `mingold`, `maxgold`, `AIName`, `MovementType`, `InhabitType`, `RacialLeader`, `RegenHealth`, `equipment_id`, `mechanic_immune_mask`, `flags_extra`, `ScriptName` FROM creature_template WHERE entry = '$entry'");
}
else
{
	// get new free id
		...
		<form method=\"post\" action=\"creature.php?action=do_update\" name=\"form1\">
			...
			<table class=\"lined\" style=\"width: 720px;\">
				...
				<tr>
					...
					<td>
						<input type=\"text\" name=\"heroic_entry\" size=\"8\" maxlength=\"3\" value=\"{$mob['heroic_entry']}\" />
					</td>
				...
				<tr>
					...
					<td>
						<input type=\"text\" name=\"minhealth\" size=\"14\" maxlength=\"10\" value=\"{$mob['minhealth']}\" />
					</td>
					<td>".makeinfocell($lang_creature['max_health'],$lang_creature['max_health_desc'])."</td>
					<td>
						<input type=\"text\" name=\"maxhealth\" size=\"14\" maxlength=\"10\" value=\"{$mob['maxhealth']}\" />
					</td>";
				...
				<tr>
					...
					<td colspan=\"2\">
						<input type=\"text\" name=\"minmana\" size=\"14\" maxlength=\"10\" value=\"{$mob['minmana']}\" />
					</td>
					<td>".makeinfocell($lang_creature['max_mana'],$lang_creature['max_mana_desc'])."</td>
					<td colspan=\"2\">
						<input type=\"text\" name=\"maxmana\" size=\"14\" maxlength=\"10\" value=\"{$mob['maxmana']}\" />
					</td>
				</tr>
				<tr>
...
<table class=\"lined\" style=\"width: 720px;\">
	...
	<tr>
		...
		<td colspan=\"2\">
			<input type=\"text\" name=\"armor\" size=\"8\" maxlength=\"10\" value=\"{$mob['armor']}\" />
		</td>
		<td>".makeinfocell($lang_creature['speed'],$lang_creature['speed_desc'])."</td>
		<td colspan=\"2\">
			<input type=\"text\" name=\"speed\" size=\"8\" maxlength=\"45\" value=\"{$mob['speed']}\" />
		</td>
	</tr>
	<tr class=\"large_bold\">
...
<table class=\"lined\" style=\"width: 720px;\">
	...
	<tr>
		...
		<td>
			<input type=\"text\" name=\"modelid_A\" size=\"8\" maxlength=\"11\" value=\"{$mob['modelid_A']}\" />
		</td>
		<td colspan=\"2\">".makeinfocell($lang_creature['modelid_A2'],$lang_creature['modelid_A2_desc'])."</td>
		<td>
			<input type=\"text\" name=\"modelid_A2\" size=\"8\" maxlength=\"11\" value=\"{$mob['modelid_A2']}\" />
		</td>
	</tr>
	<tr>
		<td colspan=\"2\">".makeinfocell($lang_creature['modelid_H'],$lang_creature['modelid_H_desc'])."</td>
		<td>
			<input type=\"text\" name=\"modelid_H\" size=\"8\" maxlength=\"11\" value=\"{$mob['modelid_H']}\" />
		</td>
		<td colspan=\"2\">".makeinfocell($lang_creature['modelid_H2'],$lang_creature['modelid_H2_desc'])."</td>
		<td>
			<input type=\"text\" name=\"modelid_H2\" size=\"8\" maxlength=\"11\" value=\"{$mob['modelid_H2']}\" />
		</td>
	</tr>
</table>
<br /><br />";
...
if ($mobequip = $sql->fetch_assoc($result1))
{
	...
	<table class=\"lined\" style=\"width: 720px;\">
		...
		<tr>
			...
			<td>
				<input type=\"text\" name=\"equipmodel1\" size=\"8\" maxlength=\"10\" value=\"{$mobequip['equipmodel1']}\" />
			</td>
			<td>".makeinfocell($lang_creature['equip_info']." 1",$lang_creature['equip_info1_desc'])."</td>
			<td>
				<input type=\"text\" name=\"equipinfo1\" size=\"8\" maxlength=\"10\" value=\"{$mobequip['equipinfo1']}\" />
			</td>
		</tr>
		<tr>
			...
			<td>
				<input type=\"text\" name=\"equipmodel2\" size=\"8\" maxlength=\"10\" value=\"{$mobequip['equipmodel2']}\" />
			</td>
			<td>".makeinfocell($lang_creature['equip_info']." 2",$lang_creature['equip_info2_desc'])."</td>
			<td>
				<input type=\"text\" name=\"equipinfo2\" size=\"8\" maxlength=\"10\" value=\"{$mobequip['equipinfo2']}\" />
			</td>
		</tr>
		<tr>
			...
			<td>
				<input type=\"text\" name=\"equipmodel3\" size=\"8\" maxlength=\"10\" value=\"{$mobequip['equipmodel3']}\" />
			</td>
			<td>".makeinfocell($lang_creature['equip_info']." 3",$lang_creature['equip_info3_desc'])."</td>
			<td>
				<input type=\"text\" name=\"equipinfo3\" size=\"8\" maxlength=\"10\" value=\"{$mobequip['equipinfo3']}\" />
			</td>
		</tr>
	</table>
<br /><br />
	...
	<table class=\"lined\" style=\"width: 720px;\">
		...
		<table class=\"hidden\" align=\"center\">
			...
			while ($item = $sql->fetch_row($result1))
			{
				...
				<td>";
				$output .= maketooltip("<img src=\"".get_item_icon($item[0])."\" class=\"icon_border\" alt=\"\" />", "$item_datasite$item[0]", $tooltip, "item_tooltip");
				$output .= "<br /><input type=\"checkbox\" name=\"del_skin_items[]\" value=\"$item[0]\" />
				</td>";
...
if ($mob['pickpocketloot'])
{
	...
	$row_flag = 0;
	$output .= "
	<table class=\"hidden\" align=\"center\"><tr>";
		...
		while ($item = $sql->fetch_row($result1))
		{
			...
			<td>";
				$output .= maketooltip("<img src=\"".get_item_icon($item[0])."\" class=\"icon_border\" alt=\"\" />", "$item_datasite$item[0]", $tooltip, "item_tooltip");
				$output .= "<br /><input type=\"checkbox\" name=\"del_pp_items[]\" value=\"$item[0]\" />
			</td>";
...
if ( ($del_trainer_spell || $del_loot_items || $del_skin_items || $del_pp_items || $del_questrelation || $del_involvedrelation || $del_vendor_item ) && $user_lvl < $action_permission['delete'] ) redirect("creature.php?error=9");
$deplang = get_lang_id();
...
$sql_query = "{$db_action_creature} INTO creature_template ( entry, difficulty_entry_1, modelid_A, modelid_H, name, subname, minlevel, maxlevel, minhealth, maxhealth, minmana, maxmana, armor, faction_A, faction_H, npcflag, speed, rank, mindmg, maxdmg, dmgschool, attackpower, baseattacktime, rangeattacktime, unit_flags, dynamicflags, family, trainer_type, trainer_spell, trainer_class, trainer_race, minrangedmg, maxrangedmg, rangedattackpower, type, flags_extra, type_flags, lootid, pickpocketloot, skinloot, resistance1, resistance2, resistance3, resistance4, resistance5, resistance6, spell1, spell2, spell3, spell4, mingold, maxgold, AIName, MovementType, InhabitType, RacialLeader, ScriptName) VALUES ( '$entry', '$heroic_entry', '$modelid_A', '$modelid_H', '$name', '$subname', '$minlevel', '$maxlevel', '$minhealth', '$maxhealth', '$minmana', '$maxmana', '$armor', '$faction_A', '$faction_A',  '$npcflag', '$speed', '$rank', '$mindmg', '$maxdmg', '$dmgschool', '$attackpower', '$baseattacktime', '$rangeattacktime', '$unit_flags', '$dynamicflags', '$family', '$trainer_type', '$trainer_spell', '$trainer_class', '$trainer_race', '$minrangedmg', '$maxrangedmg', '$rangedattackpower', '$type', '$flags_extra', '$type_flags', '$lootid', '$pickpocketloot', '$skinloot', '$resistance1', '$resistance2', '$resistance3', '$resistance4', '$resistance5', '$resistance6', '$spell1', '$spell2', '$spell3', '$spell4', '$mingold', '$maxgold', '$AIName', '$MovementType', '$InhabitType', '$RacialLeader', '$ScriptName' );\n";
